...
Donwloading products from the LP DAAC requires a NASA [EarthData](https://urs.earthdata.nasa.gov/https://urs.earthdata.nasa.gov/) login. Please, first register as an EarthData user to get login credentials.
